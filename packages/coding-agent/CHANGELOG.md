...
- Marketplace-installed plugin agents now load by default when installed through OMP; the `claude-plugins` user-source opt-in applies only to Claude Code's registry ([#11362](https://github.com/can1357/oh-my-pi/issues/11362)).
